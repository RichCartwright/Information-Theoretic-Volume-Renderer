...
MIVolumeRender: volumeRender.o volumeRender_kernel.o
...
clean:
	rm -f MIVolumeRender volumeRender.o volumeRender_kernel.o
	rm -rf ../../bin/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/MIVolumeRender
